...
class db {
	...
	public function __construct() {
		$this->dbh = mysqli_connect("localhost", "titaniu6_scout", "Titanium2013!") or die("Cannot connect, try again later!");
		mysqli_select_db($this->dbh, "titaniu6_scouting") or die("Database doesn't exist");
	}
